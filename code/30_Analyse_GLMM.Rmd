...
```{r}
mod3 <- glmer(statut_presence~annee+(1|code_site), family=binomial(link = "logit"), data = base_j25)
```
...
**Méthode des moyennes marginales estimées, ou Estimated Marginal Means (EMMeans)**



pentes<-emtrends(mod3.2,~facteur,var="covariable")1
```

Remarque : PAS OUBLIER DE REVENIR à la REPONSE

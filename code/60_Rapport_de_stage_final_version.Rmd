...
```{r, fig.cap = "Figure 6 : Synthèse du pourcentage de détection de la tendance positive significative (p value < 0.05) par le modèle GLMM des simulations, en fonction de la tendance introduite (i.e. nombres de présences annuelles ajoutées)."}

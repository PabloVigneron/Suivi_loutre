...
# Importation des données 2025 - Secteur : Lieu Greve

```{r}
base_greve_raw_25 <-
  readr::read_csv('../raw_data/AnyConv.com__sites_prospection_LieuGreve.csv',
                   col_names = T) 
```
...
```{r, fig.cap=" Statut de présence de la loutre sur les sites de prospection en fonction des années - Secteur Lieu de Greve - 1 er passage (Printemps)", fig.width = 9, fig.height = 8}
...
```{r, fig.cap=" Statut de présence de la loutre sur les sites de prospection en fonction des années - Secteur Lieu de Greve - 2 e passage (Hivernal)", fig.width = 9, fig.height = 8}
...
```{r, fig.cap="Statut d'observation des sites prospectée en fonction des années, 1er passage (printemps) ",fig.width = 9, fig.height = 7}

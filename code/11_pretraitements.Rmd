...
```{r}
mod5.0<- glmer(statut_presence~annee + observateurs_clean + passage + (1|code_site), family=binomial(link = "logit"), data = greve_year_factor_season)
```
...
```{r}
mod5.1<- glmer(statut_presence~annee + observateurs_clean + passage + (1|code_site), family=binomial(link = "probit"), data = greve_year_factor_season)
```

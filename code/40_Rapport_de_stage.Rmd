...
Cité de la biblio 
Ne pas mettre le modèle biologique en 1er 

Bref historique de la disparition de la loutre 
Statut de protection de la loutre 
France : 2 PNA 
Espèce en déclin : différentes échelles 
Recolonisation en bretagne : Bien établie 

→ Observatoire des mammifères : conserver la loutre 
Ecologie de la Loutre : 
Causes de mortalité : hiérarchie avec importance 


Bref résumé de l'écologie de la loutre 

Pour estimer la présence de la loutre : bcp de méthode : Rapport SFERM 
Le marquage comme indice de présence de l’espèce 
Protocole IUCN : protocole conçu pour une échelle nationale / 
Chanin → Proposition d’un protocole applicable dans des zones spéciale de conservation, à une échelle plus fine 
problématique : Est ce que ce protocole à l'échelle d’un bassin versant permet-il de détecter des tendances temporelles chez la loutre d’europe. Autrement dit est ce que ce protocole a un intérêt à être mis en place particulièrement dans les réserves naturelles comme méthode complémentaire de suivi locale de la loutre. 
...
common_cols <- intersect(names(sites_geo_1), names(sites_geo_2))

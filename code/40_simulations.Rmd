...
my_histo(test2) +
  geom_vline(xintercept = pente_obs, col = "black")
```
On voit que la pente estimée sur le jeu de données non permuté, de valeur très faible et non significative, est bien dans la gamme des valeurs NS après permutation.

...
trend_0 <- my_histo_season(test2, "A") +
...
trend_1 <-my_histo_season(test2, "B")
...
trend_2 <-my_histo_season(test3, "C")
...
trend_3 <-my_histo_season(test4, "D")
...
trend_4 <-my_histo_season(test5, "E")
...
trend_5 <-my_histo_season(test6, "F")
...
trend_6 <-my_histo_season(test7, "G")
...
trend_7 <-my_histo_season(test8, "H")

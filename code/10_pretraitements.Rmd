...
```{r, fig.cap="Nombre d'observations de présence de la loutre en fonction des années",fig.width = 9, fig.height = 6}
base_tregor %>%
...
```{r,fig.cap="Nombre d'observations de présence et absence de la loutre en fonction des années",fig.width = 9, fig.height = 6}
base_tregor %>%
...
```{r,fig.cap="Pourcentages de présence de la loutre en fonction des années",fig.width = 9, fig.height = 6}
base_tregor %>%
  group_by(annee) %>%
  summarise(
    n_obs = n(),
